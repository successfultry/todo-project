...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\victo.NOIPHONE\PycharmProjects\todo-manager\myvenv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\victo.NOIPHONE\PycharmProjects\todo-manager\myvenv\Scripts\deactivate.nu'
